...
This repository is in early development. As of *V0.1.4*, the identity layer
(secp256k1 keypairs, dual-key binding to Ed25519, local persistence), P2P
node bootstrap (jvm-libp2p, mDNS discovery, bootstrap dialing), and DHT +
Bitswap content storage (Nabu) are implemented — see
link:docs/architecture.adoc[docs/architecture.adoc]. The remaining modules
are still skeletons.
