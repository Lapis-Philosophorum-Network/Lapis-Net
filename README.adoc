...
image::docs/images/ln-banner.png[Lapis Net,link=https://github.com/Lapis-Philosophorum-Network/Lapis-Net]
...
This repository is in early development. As of *V0.1.3*, the identity layer
(secp256k1 keypairs, dual-key binding to Ed25519, local persistence) and P2P
node bootstrap (jvm-libp2p, mDNS discovery, bootstrap dialing) are
implemented — see link:docs/architecture.adoc[docs/architecture.adoc]. The
...
| libp2p node bootstrap, peer identity derivation, and mDNS discovery. GossipSub propagation lands in a later wave.
